...
ALL_IMAGES := \
	...
	v0.12/alpine-http:v0.12.43-http,v0.12-http,stable-http,http \
	...
	v0.12/debian-http:v0.12.43-debian-http,v0.12-debian-http,debian-http \
	...
	v1.2/debian-http:v1.2.2-debian-http,v1.2-debian-http
